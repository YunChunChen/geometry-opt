...
class MVControlNetModel(ModelMixin, ConfigMixin, FromOriginalControlnetMixin):
    ...
    def from_unet(
        ...
        self.conv_in.load_state_dict(unet.conv_in.state_dict())
        self.time_proj.load_state_dict(unet.time_proj.state_dict())
        self.time_embedding.load_state_dict(unet.time_embedding.state_dict())

        if self.class_embedding:
            self.class_embedding.load_state_dict(unet.class_embedding.state_dict())

        self.down_blocks.load_state_dict(unet.down_blocks.state_dict())
        self.mid_block.load_state_dict(unet.mid_block.state_dict())
